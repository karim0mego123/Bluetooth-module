...
/************************************************************************************/
/* Description:				function used to init PWM 								*/
/* Inputs: nothing			 	 		    										*/
/* Output: void								  						    */
/************************************************************************************/
void PWM_Init();
...
/************************************************************************************/
/* Description: Function used to measure Pwm signal from other MCU					*/
/* Inputs: Pointer to Freq , and Pointer to Duty   									*/
/* Output: void								  									    */
/************************************************************************************/
void PWM_Measure(uint32_t* Ptr_Freq , uint8_t* Ptr_Duty );

/************************************************************************************/
/* Description: Function take freq in khz from app  								*/
/* Inputs: nothing			 	 		    										*/
/* Output: void								  									    */
/************************************************************************************/
void PWM_Freq_KHz(uint16_t Freq) ;
/************************************************************************************/
/* Description: Function take freq in hz from app 									*/
/* Inputs: nothing			 	 		    										*/
/* Output: void								  									    */
/************************************************************************************/
void PWM_Freq_Hz(uint16_t Freq) ;
/************************************************************************************/
/* Description: Function take duty of Pwm 											*/
/* Inputs: nothing			 	 		    										*/
/* Output: void								  									    */
/************************************************************************************/
