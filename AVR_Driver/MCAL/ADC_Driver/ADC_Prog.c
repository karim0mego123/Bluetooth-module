...
ES_t ADC_INIT()
{
	...
	#if ( ADC_PRES == PRESCALER_2 )
	{
		PRESCALER_TWO ;
	}
	#elif ( ADC_PRES == PRESCALER_4 )
	{
		PRESCALER_FOUR	;
	}
	#elif (ADC_PRES == PRESCALER_8)
	{
		PRESCALER_EIGHT	;		
	}
	#elif (ADC_PRES == PRESCALER_16)
	{
		PRESCALER_SIXTEEN ;		
	}
	#elif (ADC_PRES == PRESCALER_32)
	{
		PRESCALER_THIRTY_TWO ;		
	}
	#elif (ADC_PRES == PRESCALER_64)
	{
		PRESCALER_SIXTY_FOUR ;		
	}
	#elif (ADC_PRES == PRESCALER_128)
	{
